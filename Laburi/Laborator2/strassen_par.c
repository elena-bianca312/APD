...
int main(int argc, char *argv[])
{
	...
	pthread_create(&tid[0], NULL, compute_m1, NULL);
	pthread_create(&tid[1], NULL, compute_m2, NULL);
	pthread_create(&tid[2], NULL, compute_m3, NULL);
	pthread_create(&tid[3], NULL, compute_m4, NULL);
	pthread_create(&tid[4], NULL, compute_m5, NULL);
	pthread_create(&tid[5], NULL, compute_m6, NULL);
	pthread_create(&tid[6], NULL, compute_m7, NULL);

	for (int i = 0; i < 7; i++) {
		pthread_join(tid[i], NULL);
	}

	pthread_create(&tid[0], NULL, compute_c11, NULL);
	pthread_create(&tid[1], NULL, compute_c12, NULL);
	pthread_create(&tid[2], NULL, compute_c21, NULL);
	pthread_create(&tid[3], NULL, compute_c22, NULL);
